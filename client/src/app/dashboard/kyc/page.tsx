      ...
      <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4 border-b pb-6">
        <div>
          ...
          <p className="text-muted-foreground mt-1 text-sm md:text-base">
            Please submit your official identification and educational certificates for account verification.
          </p>
        </div>
          ...
          <CardContent className="pt-6 flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-amber-700 dark:text-amber-400 mt-1">
                Your submitted documents have been received and are being processed by our administrative team.
                You can update or re-upload documents below if needed.
              </p>
            </div>
          </CardContent>
        </Card>
          ...
          <CardContent className="pt-6 flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-xs text-red-600 dark:text-red-400 mt-2">
                Please re-upload the required document copies below and click &quot;Submit Verification&quot;.
              </p>
            </div>
          </CardContent>
        </Card>
      ...
      <form onSubmit={handleSubmit}>
        <Card className="shadow-sm">
          <CardHeader>
            ...
            <CardDescription>
              Clear photos or scans (JPG, PNG, PDF up to 5MB each) are accepted.
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-8">
            ...
            {/* Section 2: Birth Certificate */}
            <div className="space-y-4">
              <div className="border-b pb-2">
                <h2 className="text-base font-semibold flex items-center gap-2">
                  <FileText className="h-4 w-4 text-primary" /> 2. Birth Certificate (උප්පැන්න සහතිකය)
                </h2>
              </div>
            ...
            <div className="space-y-4">
              <div className="border-b pb-2">
                <h2 className="text-base font-semibold flex items-center gap-2">
                  <FileText className="h-4 w-4 text-primary" /> 3. Educational Certificates (O/L & A/L)
                </h2>
              </div>
