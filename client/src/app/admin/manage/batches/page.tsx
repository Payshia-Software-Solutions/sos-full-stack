...
import { Search, PlusCircle, Edit, Trash2, BookOpen, AlertTriangle, Loader2, ArrowLeft } from 'lucide-react';
...
function ManageBatchesPageComponent() {
    ...
    const handleCreate = () => {
        router.push('/admin/manage/batches/create');
    };

    const handleEdit = (batch: Batch) => {
        router.push(`/admin/manage/batches/edit/${batch.id}`);
    };
    ...
    const filteredBatches = useMemo(() => {
        ...
        if (courseIdFilter) {
            filtered = filtered.filter(batch => String(batch.parent_course_id) === String(courseIdFilter));
        }
        ...
        <div className="p-4 md:p-8 space-y-6 pb-20">
            ...
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
                <div>
                    ...
                    <p className="text-muted-foreground mt-1">View, add, and edit batch information.</p>
                </div>
